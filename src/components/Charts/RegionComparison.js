...
import { prepareRegionData } from '../../utils/chartHelpers';
import { formatCurrency, formatNumber } from '../../utils/formatters';

const RegionComparison = ({ data }) => {
  // Prepare chart data
  const chartData = prepareRegionData(data);
    ...
    <div className="chart-container">
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          ...
          <Bar yAxisId="right" dataKey="count" name="Orders" fill="#b91c1c" radius={[4, 4, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
